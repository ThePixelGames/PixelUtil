...
<code style="font-size:11px">xs</code>, 
<code style="font-size:13px">sm</code>,
<code style="font-size:16px">md</code>, 
<code style="font-size:20px">lg</code>,
<code style="font-size:25px">xl</code>, 
<code style="font-size:31px">2xl</code>
